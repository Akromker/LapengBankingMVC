 ...
 * @author Alex
 */
@Component("RegularAccountBean")
@Table(name = "RegularAccounts")
public class RegularAccount extends BasicAccount {
    ...
    public RegularAccount(String Name, String Pin, double Balance) {
        name = Name;
        pin = Pin;
        balance = Balance;
        ...
        try {
            ...
            Logger.getLogger(RegularAccount.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
